...
def parse_eval_args():
    ...
    parser.add_argument(
        ...
        type=int,
        default=10000,
        help="Max roadgraph points to parse per record; must match the dataset's "
        "actual stored point count (see scripts/make_91f.py) (default: 10000)",
    )
    parser.add_argument(
        "--scenario_indexes",
        "-si",
...
def main():
    ...
    data_generator = make_data_generator(
        ...
        max_num_rg_points=eval_args.max_num_rg_points,
