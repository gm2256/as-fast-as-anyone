"""V-Max SAC baseline (run 260719_2x_timesteps) as a challenge submission.
...
# observation_config of the training run (runs/260719_2x_timesteps/.hydra/config.yaml).
OBSERVATION_CONFIG = {
...
class VmaxSacPlanner(actor_core.WaymaxActorCore):
    ...
    @property
    def name(self) -> str:
        return "vmax_sac_lq_260719_2x_timesteps"
